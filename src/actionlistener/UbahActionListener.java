...
public class UbahActionListener implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        // Instansiasi objek Update ActionListener dengan nama UpdateListener
        UpdateActionListener updateListener = new UpdateActionListener(
                this.biodataFrame,
                this.biodataDao,
                id);

        // Tambahkan action listener pada buttonUpdate
        this.biodataFrame.getButtonUpdate().addActionListener(updateListener);
    }
}